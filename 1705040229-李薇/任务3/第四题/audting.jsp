...
<%
		...
		<% int[] amoney=new int[100];
		   int n=0;
		   for(n=0;n<i;n++){
			   amoney[n]=bmoney[n]+100*people[n]+age[n]*50;
		   }%>
		  <%  int n2=0;
		   for( n2=0;n2<i;n2++){
			   if(amoney[n2]>26000){
...
<div id="tou">
		工资管理系统
		<center><div id="zj"><H1>查看教师调整后状态</H1></div></center>
	</div>
	<div>
	   <table>
				<tr>
	   ...
	   <%
	     int n3=0;
	while(n3<i){
		 //String sql_save="update teachers set bmoney=20000 where tno=2;";
		    //st.executeUpdate(sql_save);
		    //st.close();
		     n3=n3+1;
	   }
	   %>
	   <a href="#" onClick="chat()"><input type="submit" value="确认修改" class="button1"></a>
		<a href="choice.html"><input type="submit" value="取消修改，返回选择" class="button2"></a>
	</div>
</body>
</html>