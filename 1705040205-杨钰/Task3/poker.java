...
public class MainActivity extends AppCompatActivity {
    ...
    private void cardGame() {
        ...
        //等级一同花顺 权值5 ,等级二顺子 ,权值4 等级三同点 权值3 ,等级四对子 权值2 ,等级五 杂牌 权值1
        //玩家等级 默认为1
        ...
        //等级四 对子   取余数 两个一样
        if (resultc.get(0).equals(resultc.get(1)) || resultc.get(0).equals(resultc.get(2)) || resultc.get(1) == resultc.get(2)) weightValue1 = 2;
        if (resultd.get(0).equals(resultd.get(1)) || resultd.get(0).equals(resultd.get(2)) || resultd.get(1) == resultd.get(2)) weightValue2 = 2;
        //等级三 同点   取余数 三个一样
        if (resultc.get(0).equals(resultc.get(1)) && resultc.get(1).equals(resultc.get(2))) weightValue1 = 3;
        if (resultd.get(0).equals(resultd.get(1)) && resultd.get(1).equals(resultd.get(2))) weightValue2 = 3;
        //等级二 顺子   取余数
        if (resultc.get(0) == resultc.get(1) - 1 && resultc.get(0) == resultc.get(2) - 2) weightValue1 = 4;
        if (resultd.get(0) == resultd.get(1) - 1 && resultd.get(0) == resultd.get(2) - 2) weightValue2 = 4;
        //等级一 同花顺  取整数
        if (resulta.get(0).equals(resulta.get(1)) && resulta.get(0).equals(resulta.get(2))) weightValue1 = 5;
        if (resultb.get(0).equals(resultb.get(1)) && resultb.get(0).equals(resultb.get(2))) weightValue2 = 5;
