...
class MainWindow(QMainWindow):
    ...
    def Init_UI(self):
        ...
        self.menuHelpAbout = QtWidgets.QAction("关于Tkedit(&A)")
    ...
    def exit(self):
        if self.isSaved == False:
            result = QtWidgets.QMessageBox.question(self, 'Tkedit', '是否将更改保存到' + self.openFileName,
    ...
    def about(self):
        ...
        QtWidgets.QMessageBox.about(self, "关于我们", "Powered by Hnust.1705040205")
    def textChange(self):
        self.isSaved = False
        self.setWindowTitle(self.openFileName + ' - Tkedit *')
